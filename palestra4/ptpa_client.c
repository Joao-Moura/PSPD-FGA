...
main (int argc, char *argv)
{
        ...
        if (rank == 0) {
                ...
                MPI_Issend (msg, 13, MPI_CHAR, 1, tipo, MPI_COMM_WORLD, &request);
                ...
                strcpy(msg, "Hello World\0");
                MPI_Irsend (msg, 13, MPI_CHAR, 2, tipo, MPI_COMM_WORLD, &request);
                ...
                strcpy(msg, "Hello World\0");
                MPI_Ibsend (msg, 13, MPI_CHAR, 3, tipo, MPI_COMM_WORLD, &request);
